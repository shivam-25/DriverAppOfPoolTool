...
import com.example.android.driverapp.Common.Common;
import com.example.android.driverapp.Model.Token;
...

{
    ...
    final Runnable drawPathRunnable = new Runnable() {
        @Override
        public void run() {
...
*/
        ...
        /*btnGo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                destination = destination.replace(" ","+"); //Replace with + for fetch data
                Log.d("Shivam", destination);
                getDirection();
            }
        });*/
